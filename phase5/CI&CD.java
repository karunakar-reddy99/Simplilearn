...
<html lang="en">
<head>
<title>Karunakar Reddy's Assessment</title>
<!-- Bootstrap -->
...
<div id="about">
<h1>
<div style='float: left; margin-bottom: 16px;'>Raji Reddy's
</div>
<div class="stage">
<div class="pyramid3d">
...
product stage, demonstrating the automated, integrated, 
and
...
<p>Feel free to contact Raji Reddy with any new requests 
or
...
.side1 { -webkit-transform: translatex(0) rotatey(115.2deg) rotatez(90deg); transform: translatex(0) 
rotatey(115.2deg) rotatez(90deg); }
.side2 { -webkit-transform: translatex(150px) rotatez(90deg) rotatex(64.8deg); transform: 
translatex(150px) rotatez(90deg) rotatex(64.8deg); }
.side3 { -webkit-transform: translatez(0) rotatex(64.8deg); transform: translatez(0) rotatex(64.8deg); 
}
.side4 { -webkit-transform: translatey(150px) rotatex(115.2deg); transform: translatey(150px) 
rotatex(115.2deg); }
